    ...
    <nav className="navbar glass">
      <div className="container nav-container">
        ...
        <ul className="nav-links">
          ...
          <li><NavLink to="/charms">Bộ sưu tập Charm</NavLink></li>
          <li><NavLink to="/designer">Thiết kế vòng</NavLink></li>
          <li><NavLink to="/my-designs">Mẫu của tôi</NavLink></li>
        ...
        <div className="nav-actions">
          <button className="cart-icon-btn" onClick={() => navigate('/cart')}>
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="cart-svg">
