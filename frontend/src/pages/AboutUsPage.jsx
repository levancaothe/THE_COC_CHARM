    ...
    <div className="about-page">
      <section className="about-hero">
        ...
        <p className="about-intro">
          ...
          làm đẹp đơn thuần, mà là nơi gửi gắm cảm xúc, kỷ niệm và dấu ấn cá
          nhân của mỗi người. Mỗi chiếc vòng là một phiên bản rất riêng, được
          tạo ra để đồng hành cùng bạn trong những khoảnh khắc đáng nhớ.
        </p>
      </section>
      ...
      >
        ...
        <div className="about-commitment__body">
          <p>
            Chúng tôi không ngừng hoàn thiện để mang lại trải nghiệm đẹp nhất từ
            lúc bạn bắt đầu chọn charm, trong quá trình chế tác, cho đến khi
            nhận sản phẩm cuối cùng. Từ khâu kiểm tra chất lượng, đóng gói đến
            hỗ trợ sau bán, mọi chi tiết đều được xử lý chỉn chu.
          </p>
          <p className="about-quote">
            “The Cóc Charm không chỉ bán vòng tay, mà còn lưu giữ những câu
            chuyện mà bạn muốn trân trọng.”
          </p>
          <p>
            Hãy cùng chúng tôi tạo nên một món trang sức phản chiếu cá tính của
            riêng bạn, giản dị nhưng có chiều sâu, tinh tế nhưng vẫn rất riêng.
          </p>
        </div>
      </section>
      ...
      <section id="about-video-section" className="about-video-section" aria-labelledby="about-video-title">
        ...
        <p className="about-video-subtitle">
          Khám phá cách chúng tôi giúp bạn tự tay thiết kế và lưu giữ câu chuyện của riêng mình qua từng chi tiết.
        </p>
