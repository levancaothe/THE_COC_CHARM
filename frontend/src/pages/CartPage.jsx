          ...
          <section className="checkout-section" ref={checkoutRef}>
            <form className="checkout-form-card" onSubmit={handleCheckout}>
              ...
              <fieldset>
                ...
                <div className="payment-box">
                  <p>
                    The Cóc Charm áp dụng hình thức thanh toán chuyển khoản 100%
                    cho các thiết kế cá nhân hóa.
                  </p>
            ...
            <aside className="checkout-summary-card">
              ...
              <p className="checkout-note">
                Sản phẩm được chế tác thủ công, đóng gói trong hộp có kèm thẻ
                bảo hành chính hãng từ The Cóc Charm.
              </p>
            </aside>
          </section>
        )}
